 ...
 * @author kevindong
 */
@FacesConverter("galleryCategoryConverter")
public class GalleryCategoryConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if (value.trim().equals("")) {
            ...
            try {
                GalleryCategory entity = categoryBean.findById(Integer.parseInt(value));
                if (entity != null) {
                    return entity;
                } else {
                    return null;
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return ((GalleryCategory) value).getId().toString();
        }
    }
