 ...
 * @author kevindong
 */
@FacesConverter("questionCategoryConverter")
public class QuestionCategoryConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if (value.trim().equals("")) {
            ...
            try {
                QuestionCategory entity = categoryBean.findById(Integer.parseInt(value));
                if (entity != null) {
                    return entity;
                } else {
                    return null;
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return ((QuestionCategory) value).getId().toString();
        }
    }
