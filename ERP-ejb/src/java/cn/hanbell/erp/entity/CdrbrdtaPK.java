 ...
 */
@Embeddable
public class CdrbrdtaPK implements Serializable {
    ...
    public CdrbrdtaPK(String facno, String brtrno, short trseq) {
        this.facno = facno;
        this.brtrno = brtrno;
        this.trseq = trseq;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CdrbrdtaPK)) {
            return false;
        }
        CdrbrdtaPK other = (CdrbrdtaPK) object;
    ...
    public String toString() {
        return "cn.hanbell.erp.entity.CdrbrdtaPK[ facno=" + facno + ", brtrno=" + brtrno + ", trseq=" + trseq + " ]";
    }
