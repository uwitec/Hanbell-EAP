 ...
 */
@Embeddable
public class PurdaskPK implements Serializable {
    ...
    public PurdaskPK(String facno, String prono, String prno, short trseq) {
        this.facno = facno;
        this.prono = prono;
        this.prno = prno;
        this.trseq = trseq;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PurdaskPK)) {
            return false;
        }
        PurdaskPK other = (PurdaskPK) object;
    ...
    public String toString() {
        return "cn.hanbell.erp.entity.PurdaskPK[ facno=" + facno + ", prono=" + prono + ", prno=" + prno + ", trseq=" + trseq + " ]";
    }
