 ...
 */
@Embeddable
public class PurqnamPK implements Serializable {
    ...
    public PurqnamPK(String facno, String prono, String prno, short trseq) {
        this.facno = facno;
        this.prono = prono;
        this.prno = prno;
        this.trseq = trseq;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PurqnamPK)) {
            return false;
        }
        PurqnamPK other = (PurqnamPK) object;
