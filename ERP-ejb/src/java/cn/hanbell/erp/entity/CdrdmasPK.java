 ...
 */
@Embeddable
public class CdrdmasPK implements Serializable {
    ...
    public CdrdmasPK(String facno, String cdrno, short trseq) {
        this.facno = facno;
        this.cdrno = cdrno;
        this.trseq = trseq;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CdrdmasPK)) {
            return false;
        }
        CdrdmasPK other = (CdrdmasPK) object;
    ...
    public String toString() {
        return "shberp.entity.CdrdmasPK[ facno=" + facno + ", cdrno=" + cdrno + ", trseq=" + trseq + " ]";
    }
