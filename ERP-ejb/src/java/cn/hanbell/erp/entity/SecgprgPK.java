 ...
 */
@Embeddable
public class SecgprgPK implements Serializable {
    ...
    public SecgprgPK(String prgno, String sysno, String groupno, String gtype) {
        this.prgno = prgno;
        this.sysno = sysno;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SecgprgPK)) {
            return false;
        }
        SecgprgPK other = (SecgprgPK) object;
    ...
    public String toString() {
        return "cn.hanbell.erp.entity.SecgprgPK[ prgno=" + prgno + ", sysno=" + sysno + ", groupno=" + groupno + ", gtype=" + gtype + " ]";
    }
