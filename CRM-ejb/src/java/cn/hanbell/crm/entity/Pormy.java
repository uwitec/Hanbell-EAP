...
@NamedQueries({
    ...
    @NamedQuery(name = "Pormy.findByMy003", query = "SELECT p FROM Pormy p WHERE p.my003 = :my003"),
    @NamedQuery(name = "Pormy.findByMy004", query = "SELECT p FROM Pormy p WHERE p.my004 = :my004"),
    @NamedQuery(name = "Pormy.findByMy005", query = "SELECT p FROM Pormy p WHERE p.my005 = :my005"),
    @NamedQuery(name = "Pormy.findByMy006", query = "SELECT p FROM Pormy p WHERE p.my006 = :my006"),
    @NamedQuery(name = "Pormy.findByMy007", query = "SELECT p FROM Pormy p WHERE p.my007 = :my007"),
    @NamedQuery(name = "Pormy.findByMy008", query = "SELECT p FROM Pormy p WHERE p.my008 = :my008"),
    @NamedQuery(name = "Pormy.findByMy009", query = "SELECT p FROM Pormy p WHERE p.my009 = :my009"),
    @NamedQuery(name = "Pormy.findByMy010", query = "SELECT p FROM Pormy p WHERE p.my010 = :my010"),
    @NamedQuery(name = "Pormy.findByMy011", query = "SELECT p FROM Pormy p WHERE p.my011 = :my011"),
    @NamedQuery(name = "Pormy.findByMy012", query = "SELECT p FROM Pormy p WHERE p.my012 = :my012"),
    @NamedQuery(name = "Pormy.findByMy013", query = "SELECT p FROM Pormy p WHERE p.my013 = :my013"),
    @NamedQuery(name = "Pormy.findByMy014", query = "SELECT p FROM Pormy p WHERE p.my014 = :my014"),
    @NamedQuery(name = "Pormy.findByMy015", query = "SELECT p FROM Pormy p WHERE p.my015 = :my015"),
    @NamedQuery(name = "Pormy.findByMy016", query = "SELECT p FROM Pormy p WHERE p.my016 = :my016"),
    @NamedQuery(name = "Pormy.findByMy017", query = "SELECT p FROM Pormy p WHERE p.my017 = :my017"),
    @NamedQuery(name = "Pormy.findByMy018", query = "SELECT p FROM Pormy p WHERE p.my018 = :my018"),
    @NamedQuery(name = "Pormy.findByMy019", query = "SELECT p FROM Pormy p WHERE p.my019 = :my019"),
    @NamedQuery(name = "Pormy.findByMy020", query = "SELECT p FROM Pormy p WHERE p.my020 = :my020"),
    @NamedQuery(name = "Pormy.findByMy021", query = "SELECT p FROM Pormy p WHERE p.my021 = :my021"),
    @NamedQuery(name = "Pormy.findByMy022", query = "SELECT p FROM Pormy p WHERE p.my022 = :my022"),
    @NamedQuery(name = "Pormy.findByMy023", query = "SELECT p FROM Pormy p WHERE p.my023 = :my023"),
    @NamedQuery(name = "Pormy.findByMy024", query = "SELECT p FROM Pormy p WHERE p.my024 = :my024"),
    @NamedQuery(name = "Pormy.findByMy025", query = "SELECT p FROM Pormy p WHERE p.my025 = :my025"),
    @NamedQuery(name = "Pormy.findByMy026", query = "SELECT p FROM Pormy p WHERE p.my026 = :my026"),
    @NamedQuery(name = "Pormy.findByMy027", query = "SELECT p FROM Pormy p WHERE p.my027 = :my027"),
    @NamedQuery(name = "Pormy.findByMy028", query = "SELECT p FROM Pormy p WHERE p.my028 = :my028"),
    @NamedQuery(name = "Pormy.findByMy029", query = "SELECT p FROM Pormy p WHERE p.my029 = :my029"),
    @NamedQuery(name = "Pormy.findByMy030", query = "SELECT p FROM Pormy p WHERE p.my030 = :my030"),
    @NamedQuery(name = "Pormy.findByMy031", query = "SELECT p FROM Pormy p WHERE p.my031 = :my031"),
