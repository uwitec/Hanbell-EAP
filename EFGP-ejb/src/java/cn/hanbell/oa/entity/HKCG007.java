...
@NamedQueries({
    ...
    @NamedQuery(name = "HKCG007.findByTextbox112", query = "SELECT h FROM HKCG007 h WHERE h.textbox112 = :textbox112"),
    @NamedQuery(name = "HKCG007.findByCenterid", query = "SELECT h FROM HKCG007 h WHERE h.centerid = :centerid"),
    @NamedQuery(name = "HKCG007.findByTextArea80", query = "SELECT h FROM HKCG007 h WHERE h.textArea80 = :textArea80"),
    @NamedQuery(name = "HKCG007.findByDate65", query = "SELECT h FROM HKCG007 h WHERE h.date65 = :date65"),
    @NamedQuery(name = "HKCG007.findByTextbox114", query = "SELECT h FROM HKCG007 h WHERE h.textbox114 = :textbox114"),
    @NamedQuery(name = "HKCG007.findByTextbox111", query = "SELECT h FROM HKCG007 h WHERE h.textbox111 = :textbox111"),
    @NamedQuery(name = "HKCG007.findByBudgetcode", query = "SELECT h FROM HKCG007 h WHERE h.budgetcode = :budgetcode"),
    @NamedQuery(name = "HKCG007.findByTextbox116", query = "SELECT h FROM HKCG007 h WHERE h.textbox116 = :textbox116"),
    @NamedQuery(name = "HKCG007.findByAppunit", query = "SELECT h FROM HKCG007 h WHERE h.appunit = :appunit"),
    @NamedQuery(name = "HKCG007.findByBudgetacc", query = "SELECT h FROM HKCG007 h WHERE h.budgetacc = :budgetacc"),
    @NamedQuery(name = "HKCG007.findBySpdsc", query = "SELECT h FROM HKCG007 h WHERE h.spdsc = :spdsc"),
    @NamedQuery(name = "HKCG007.findByDmark1", query = "SELECT h FROM HKCG007 h WHERE h.dmark1 = :dmark1"),
    @NamedQuery(name = "HKCG007.findByAskdate", query = "SELECT h FROM HKCG007 h WHERE h.askdate = :askdate"),
    @NamedQuery(name = "HKCG007.findByPurhaskdscs", query = "SELECT h FROM HKCG007 h WHERE h.purhaskdscs = :purhaskdscs"),
    @NamedQuery(name = "HKCG007.findByDmark2", query = "SELECT h FROM HKCG007 h WHERE h.dmark2 = :dmark2"),
    @NamedQuery(name = "HKCG007.findByEmgyn", query = "SELECT h FROM HKCG007 h WHERE h.emgyn = :emgyn"),
    @NamedQuery(name = "HKCG007.findByBuyer", query = "SELECT h FROM HKCG007 h WHERE h.buyer = :buyer"),
    @NamedQuery(name = "HKCG007.findByIsNine", query = "SELECT h FROM HKCG007 h WHERE h.isNine = :isNine"),
    @NamedQuery(name = "HKCG007.findByTextbox104", query = "SELECT h FROM HKCG007 h WHERE h.textbox104 = :textbox104"),
    @NamedQuery(name = "HKCG007.findByTextbox103", query = "SELECT h FROM HKCG007 h WHERE h.textbox103 = :textbox103"),
    @NamedQuery(name = "HKCG007.findByTextbox102", query = "SELECT h FROM HKCG007 h WHERE h.textbox102 = :textbox102"),
    @NamedQuery(name = "HKCG007.findByCtramts", query = "SELECT h FROM HKCG007 h WHERE h.ctramts = :ctramts"),
    @NamedQuery(name = "HKCG007.findByTextbox101", query = "SELECT h FROM HKCG007 h WHERE h.textbox101 = :textbox101"),
    @NamedQuery(name = "HKCG007.findByCtotaly", query = "SELECT h FROM HKCG007 h WHERE h.ctotaly = :ctotaly"),
    @NamedQuery(name = "HKCG007.findByProno", query = "SELECT h FROM HKCG007 h WHERE h.prono = :prono"),
    @NamedQuery(name = "HKCG007.findByDeptYear", query = "SELECT h FROM HKCG007 h WHERE h.deptYear = :deptYear"),
    @NamedQuery(name = "HKCG007.findByCtotamts", query = "SELECT h FROM HKCG007 h WHERE h.ctotamts = :ctotamts"),
    @NamedQuery(name = "HKCG007.findByTextbox15", query = "SELECT h FROM HKCG007 h WHERE h.textbox15 = :textbox15"),
    @NamedQuery(name = "HKCG007.findByPosrccode", query = "SELECT h FROM HKCG007 h WHERE h.posrccode = :posrccode"),
    @NamedQuery(name = "HKCG007.findByTextbox10", query = "SELECT h FROM HKCG007 h WHERE h.textbox10 = :textbox10"),
    @NamedQuery(name = "HKCG007.findByProperty", query = "SELECT h FROM HKCG007 h WHERE h.property = :property"),
    @NamedQuery(name = "HKCG007.findByTextbox108", query = "SELECT h FROM HKCG007 h WHERE h.textbox108 = :textbox108"),
    @NamedQuery(name = "HKCG007.findByCfmuserno", query = "SELECT h FROM HKCG007 h WHERE h.cfmuserno = :cfmuserno"),
    @NamedQuery(name = "HKCG007.findByTextbox106", query = "SELECT h FROM HKCG007 h WHERE h.textbox106 = :textbox106"),
    @NamedQuery(name = "HKCG007.findByTextbox64", query = "SELECT h FROM HKCG007 h WHERE h.textbox64 = :textbox64"),
    @NamedQuery(name = "HKCG007.findByTax", query = "SELECT h FROM HKCG007 h WHERE h.tax = :tax"),
    @NamedQuery(name = "HKCG007.findByUnpris", query = "SELECT h FROM HKCG007 h WHERE h.unpris = :unpris"),
    @NamedQuery(name = "HKCG007.findByQtotaly", query = "SELECT h FROM HKCG007 h WHERE h.qtotaly = :qtotaly"),
    @NamedQuery(name = "HKCG007.findByTextbox62", query = "SELECT h FROM HKCG007 h WHERE h.textbox62 = :textbox62"),
    @NamedQuery(name = "HKCG007.findByTextbox63", query = "SELECT h FROM HKCG007 h WHERE h.textbox63 = :textbox63"),
    @NamedQuery(name = "HKCG007.findByPrkind", query = "SELECT h FROM HKCG007 h WHERE h.prkind = :prkind"),
    @NamedQuery(name = "HKCG007.findByPurdaskdescs", query = "SELECT h FROM HKCG007 h WHERE h.purdaskdescs = :purdaskdescs"),
    @NamedQuery(name = "HKCG007.findByGuige", query = "SELECT h FROM HKCG007 h WHERE h.guige = :guige"),
    @NamedQuery(name = "HKCG007.findByQtotamts", query = "SELECT h FROM HKCG007 h WHERE h.qtotamts = :qtotamts"),
    @NamedQuery(name = "HKCG007.findByMastbuyer", query = "SELECT h FROM HKCG007 h WHERE h.mastbuyer = :mastbuyer"),
    @NamedQuery(name = "HKCG007.findByTextbox0", query = "SELECT h FROM HKCG007 h WHERE h.textbox0 = :textbox0"),
    @NamedQuery(name = "HKCG007.findByOid", query = "SELECT h FROM HKCG007 h WHERE h.oid = :oid"),
    @NamedQuery(name = "HKCG007.findByTextbox4", query = "SELECT h FROM HKCG007 h WHERE h.textbox4 = :textbox4"),
    @NamedQuery(name = "HKCG007.findByTextbox3", query = "SELECT h FROM HKCG007 h WHERE h.textbox3 = :textbox3"),
    @NamedQuery(name = "HKCG007.findByBudgetaccname", query = "SELECT h FROM HKCG007 h WHERE h.budgetaccname = :budgetaccname"),
    @NamedQuery(name = "HKCG007.findByMastbuyername", query = "SELECT h FROM HKCG007 h WHERE h.mastbuyername = :mastbuyername"),
    @NamedQuery(name = "HKCG007.findByCtaxamts", query = "SELECT h FROM HKCG007 h WHERE h.ctaxamts = :ctaxamts"),
    @NamedQuery(name = "HKCG007.findByTextbox7", query = "SELECT h FROM HKCG007 h WHERE h.textbox7 = :textbox7"),
    @NamedQuery(name = "HKCG007.findByAppuser", query = "SELECT h FROM HKCG007 h WHERE h.appuser = :appuser"),
    @NamedQuery(name = "HKCG007.findByFacno", query = "SELECT h FROM HKCG007 h WHERE h.facno = :facno"),
    @NamedQuery(name = "HKCG007.findByCurrency", query = "SELECT h FROM HKCG007 h WHERE h.currency = :currency"),
    @NamedQuery(name = "HKCG007.findByCreator", query = "SELECT h FROM HKCG007 h WHERE h.creator = :creator"),
    @NamedQuery(name = "HKCG007.findByTaxrate", query = "SELECT h FROM HKCG007 h WHERE h.taxrate = :taxrate"),
    @NamedQuery(name = "HKCG007.findByQtotalyRMB", query = "SELECT h FROM HKCG007 h WHERE h.qtotalyRMB = :qtotalyRMB"),
    @NamedQuery(name = "HKCG007.findByCtotalyRMB", query = "SELECT h FROM HKCG007 h WHERE h.ctotalyRMB = :ctotalyRMB"),
    @NamedQuery(name = "HKCG007.findByTextbox95", query = "SELECT h FROM HKCG007 h WHERE h.textbox95 = :textbox95"),
    @NamedQuery(name = "HKCG007.findByAccPeriod", query = "SELECT h FROM HKCG007 h WHERE h.accPeriod = :accPeriod"),
    @NamedQuery(name = "HKCG007.findByTextbox93", query = "SELECT h FROM HKCG007 h WHERE h.textbox93 = :textbox93"),
    @NamedQuery(name = "HKCG007.findByRate", query = "SELECT h FROM HKCG007 h WHERE h.rate = :rate"),
    @NamedQuery(name = "HKCG007.findByTextbox94", query = "SELECT h FROM HKCG007 h WHERE h.textbox94 = :textbox94"),
    @NamedQuery(name = "HKCG007.findByHmark1", query = "SELECT h FROM HKCG007 h WHERE h.hmark1 = :hmark1"),
    @NamedQuery(name = "HKCG007.findByAccYear", query = "SELECT h FROM HKCG007 h WHERE h.accYear = :accYear"),
    @NamedQuery(name = "HKCG007.findByDmark1name", query = "SELECT h FROM HKCG007 h WHERE h.dmark1name = :dmark1name"),
    @NamedQuery(name = "HKCG007.findByItnbr", query = "SELECT h FROM HKCG007 h WHERE h.itnbr = :itnbr"),
    @NamedQuery(name = "HKCG007.findByPSN", query = "SELECT h FROM HKCG007 h WHERE h.processSerialNumber = :psn"),
    @NamedQuery(name = "HKCG007.findByAppDate", query = "SELECT h FROM HKCG007 h WHERE h.appDate = :appDate"),
    @NamedQuery(name = "HKCG007.findByTextbox91", query = "SELECT h FROM HKCG007 h WHERE h.textbox91 = :textbox91"),
    @NamedQuery(name = "HKCG007.findByTextbox56", query = "SELECT h FROM HKCG007 h WHERE h.textbox56 = :textbox56"),
    @NamedQuery(name = "HKCG007.findByTextbox92", query = "SELECT h FROM HKCG007 h WHERE h.textbox92 = :textbox92"),
    @NamedQuery(name = "HKCG007.findByTextbox55", query = "SELECT h FROM HKCG007 h WHERE h.textbox55 = :textbox55"),
    @NamedQuery(name = "HKCG007.findByDeptPeriod", query = "SELECT h FROM HKCG007 h WHERE h.deptPeriod = :deptPeriod"),
    @NamedQuery(name = "HKCG007.findByCproname", query = "SELECT h FROM HKCG007 h WHERE h.cproname = :cproname"),
    @NamedQuery(name = "HKCG007.findByApamts", query = "SELECT h FROM HKCG007 h WHERE h.apamts = :apamts"),
    @NamedQuery(name = "HKCG007.findBySqr", query = "SELECT h FROM HKCG007 h WHERE h.sqr = :sqr"),
    @NamedQuery(name = "HKCG007.findByItdsc", query = "SELECT h FROM HKCG007 h WHERE h.itdsc = :itdsc"),
    @NamedQuery(name = "HKCG007.findByZddw", query = "SELECT h FROM HKCG007 h WHERE h.zddw = :zddw"),
    @NamedQuery(name = "HKCG007.findByFormid", query = "SELECT h FROM HKCG007 h WHERE h.formid = :formid"),
    @NamedQuery(name = "HKCG007.findByProattr", query = "SELECT h FROM HKCG007 h WHERE h.proattr = :proattr"),
    @NamedQuery(name = "HKCG007.findByTextbox82", query = "SELECT h FROM HKCG007 h WHERE h.textbox82 = :textbox82"),
    @NamedQuery(name = "HKCG007.findByDepno", query = "SELECT h FROM HKCG007 h WHERE h.depno = :depno"),
    @NamedQuery(name = "HKCG007.findByPrqy1", query = "SELECT h FROM HKCG007 h WHERE h.prqy1 = :prqy1"),
    @NamedQuery(name = "HKCG007.findByTextbox84", query = "SELECT h FROM HKCG007 h WHERE h.textbox84 = :textbox84"),
    @NamedQuery(name = "HKCG007.findByTextbox85", query = "SELECT h FROM HKCG007 h WHERE h.textbox85 = :textbox85"),
    @NamedQuery(name = "HKCG007.findBySource", query = "SELECT h FROM HKCG007 h WHERE h.source = :source"),
    @NamedQuery(name = "HKCG007.findByIstechnique", query = "SELECT h FROM HKCG007 h WHERE h.istechnique = :istechnique"),
    @NamedQuery(name = "HKCG007.findByRqtdate", query = "SELECT h FROM HKCG007 h WHERE h.rqtdate = :rqtdate"),
    @NamedQuery(name = "HKCG007.findByDmark2name", query = "SELECT h FROM HKCG007 h WHERE h.dmark2name = :dmark2name"),
    @NamedQuery(name = "HKCG007.findByVdrno", query = "SELECT h FROM HKCG007 h WHERE h.vdrno = :vdrno"),
    @NamedQuery(name = "HKCG007.findByFSN", query = "SELECT h FROM HKCG007 h WHERE h.formSerialNumber = :fsn"),
    @NamedQuery(name = "HKCG007.findByTextbox81", query = "SELECT h FROM HKCG007 h WHERE h.textbox81 = :textbox81"),
    @NamedQuery(name = "HKCG007.findByYfPrice", query = "SELECT h FROM HKCG007 h WHERE h.yfPrice = :yfPrice"),
    @NamedQuery(name = "HKCG007.findByVdrna", query = "SELECT h FROM HKCG007 h WHERE h.vdrna = :vdrna"),
    @NamedQuery(name = "HKCG007.findByBuyername", query = "SELECT h FROM HKCG007 h WHERE h.buyername = :buyername"),
    @NamedQuery(name = "HKCG007.findByAddcode", query = "SELECT h FROM HKCG007 h WHERE h.addcode = :addcode")})
