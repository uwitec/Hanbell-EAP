...
@NamedQueries({
    ...
    @NamedQuery(name = "HKCW002.findByProcessSerialNumber", query = "SELECT h FROM HKCW002 h WHERE h.processSerialNumber = :processSerialNumber"),
    ...
    @NamedQuery(name = "HKCW002.findByFormSerialNumber", query = "SELECT h FROM HKCW002 h WHERE h.formSerialNumber = :formSerialNumber"),
