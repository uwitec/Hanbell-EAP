 ...
 */
@Stateless
public class MaintenanceBean extends SuperEJBForEAP<Maintenance> {

    @EJB
    private MaintenanceDetailBean galleryDetailBean;
    ...
    @Override
    public JsonObjectBuilder createJsonObjectBuilder(Maintenance entity) {
    ...
    public List<Maintenance> findByCategoryId(Object id) {
        Query query = getEntityManager().createNamedQuery("Maintenance.findByCategoryId");
